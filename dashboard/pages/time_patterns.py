...
dash.register_page(__name__, path="/time-patterns", name="Time Patterns", order=3, icon="◷")
        ...
        html.Div(
            [
                panel(
                    ...
                    graph(empty_figure(), "time-hourly"),
                    "Average departure delay; 05:00–21:00 typically shows the strongest climb",
                    "panel-wide",
                ),
                panel("Day-of-week pattern", graph(empty_figure(), "time-weekday"), "Average departure delay"),
                panel("Seasonality", graph(empty_figure(), "time-monthly"), "Monthly delay and cancellation pressure"),
            ],
...
def update_time_patterns(filter_data):
    ...
    style_figure(hourly_fig, height=390)
    ...
    style_figure(weekday_fig, height=340)
    ...
    style_figure(monthly_fig, height=340)
